...
public class MovimientoUseCase {
    ...
    public Movimiento guardarMovimiento(Movimiento movimiento) {
        ...
        Cuenta cuentaConNuevoSaldo = aplicarNuevoSaldoEnCuenta(movimientoAplicado.getCuenta()/*, movimientoAplicado.getValorMovimiento()*/);
    ...
    private Cuenta aplicarNuevoSaldoEnCuenta(Cuenta cuenta/*, Long valorMovimiento*/) {
